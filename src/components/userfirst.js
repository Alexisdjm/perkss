            ...
            <section id="user-first" className="como scroll-reveal">
                <div className="container">
                    ...
                    <div className="col-lg-6 text-end pull-left order-lg-1">
                        ...
                        <p>
                        Perkss es la primera app de fidelidad diseñada para tí, shopper del futuro. Desde un solo lugar, podrás participar en los programas de fidelidad de tus marcas favoritas<br></br><br></br>
